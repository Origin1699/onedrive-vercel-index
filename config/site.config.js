...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'mjz@origin1699.onmicrosoft.com',
  ...
  title: "Kaori Miyazono's OneDrive",
  ...
  protectedRoutes: ['/Downloads/NSFW'],
